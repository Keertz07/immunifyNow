    ...
    <div class="hero">
        ...
        <h1>${message}</h1>
            ...
            <form action="loginUser" method="post" id="loginss" class="input-group">
                ...
                <a style="text-align:center; text-decoration:none; color:black;width:180px;font-weight:light;
                margin-top:20px;"S class="submit-btns" href="loginAdmin"><h5>Login As Admin</h5></a>
            </form>
            <form action="register" method="post" id="registerss" class="input-group">
                ...
                <input type="text" class="input-field" name="password" placeholder="Enter Password" required>
                <input type="text" class="input-field" name="mobileno" placeholder="Mobile Number" required>
